...
if source == "DialogCodeHook":
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you for your information; For your Risk Level {} here is your Investment Recommendation {}.""".format(
...
def GetRecommendation(risk_level):
    if(risk_level is None):
        recommendation = 'You have provided an Invalid Risk Level. Please Try again'
    if risk_level == 'None':
    ...
    if age is not None:
        ...
        if age < 0 or age >65:
            return build_validation_result(
                False,
                "age",
                "You should be at between the age 0 to 65 to use this service, "
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investment_amount",
                "The amount to invest should be 5000 or greater, "
